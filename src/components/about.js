          ...
          <Row>
            ...
            <Col sm='12'>
              <p id="About">
                ...
                International Maritime Organization and small municipalities. He
                is passionate about delivering an intuitive, organized product
                that goes beyond the client's needs. Kevin has shifted his focus
                from the scientific community to software, where he is
                passionate about developing web and mobile-applications with
                React, React Native and Redux. He is highly skilled in CSS
                preprocessors, such as SASS and enjoys creating aesthetic,
                simple designs.
              </p>
            </Col>
          </Row>
